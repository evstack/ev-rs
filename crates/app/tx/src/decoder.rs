...
mod tests {
    ...
    fn test_ethereum_decoder_types() {
        ...
        assert!(!decoder.is_allowed(tx_type::EVOLVE_BATCH));
    }

    #[test]
    fn test_custom_types() {
        let decoder = TypedTxDecoder::with_types([tx_type::EIP1559, tx_type::EVOLVE_BATCH]);
    ...
    fn test_allow_type_builder() {
        ...
        decoder.allow_type(tx_type::EVOLVE_BATCH);
