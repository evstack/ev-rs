...
mod tests {
    ...
    fn update_begin_blockers_requires_runtime_sender() {
        ...
        let result = scheduler.update_begin_blockers(vec![AccountId::from_u64(10)], &mut env);
    ...
    fn update_end_blockers_requires_runtime_sender() {
        ...
        let result = scheduler.update_end_blockers(vec![AccountId::from_u64(20)], &mut env);
        assert!(matches!(result, Err(e) if e == ERR_UNAUTHORIZED));
    ...
    fn runtime_can_update_blockers() {
        ...
        scheduler
            .update_begin_blockers(
                vec![AccountId::from_u64(10), AccountId::from_u64(11)],
                &mut env,
            )
            .unwrap();
        scheduler
            .update_end_blockers(vec![AccountId::from_u64(20)], &mut env)
            .unwrap();
